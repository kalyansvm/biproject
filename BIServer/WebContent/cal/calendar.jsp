...
<style type="text/css">@import url(${pageContext.request.contextPath}/cal/calendar-win2k-1.css);</style>
<script type="text/javascript" src="${pageContext.request.contextPath}/cal/calendar.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/cal/calendar-setup.js"></script>
