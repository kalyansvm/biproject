...
public class XMLA_DrillThroughTableModel extends AbstractTableModel {
	...
	private String title = 
		resources.getString("jpivot.MondrianDrillThroughTableModel.label.drillThroughTable");
...
//			drillModel.initializeDrillThrough();
	...
	public String getCaption() {
		return Resources.instance().getOptionalString(caption, caption); // e.g., Measures
	}
