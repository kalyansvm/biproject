...
public class StatusLine {
  ...
  private String getMessageHTML() {
    ...
    s = resources.getString("jsp.wcf.statusLine.message.format.html", s);
    return s;
  }

  private String getMessageText() {
    return resources.getString("jsp.wcf.statusLine.message.format.text", message);
  }

  private String getErrorHTML() {
    return getErrorFmt("jsp.wcf.statusLine.error.format.html");
  }

  private String getErrorText() {
    return getErrorFmt("jsp.wcf.statusLine.error.format.text");
  }
