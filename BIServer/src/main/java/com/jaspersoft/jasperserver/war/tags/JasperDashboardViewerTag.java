...
/**
 * Renders dashboard compliant view
 * Minimu size
 * No buttons for export or pagination controls
 * NOTE: needs optimizing - there are a lot of redundancies between this and JasperViewerTag
 */
public class JasperDashboardViewerTag extends RequestContextAwareTag
{
	protected static final Log log = LogFactory.getLog(JasperViewerTag.class);

	public static final String DEFAULT_RENDER_JSP = "/WEB-INF/jsp/JasperDashboardViewer.jsp";
	...
	public int doEndTag() throws JspException
	{
		...
		try {
			...
			if (!emptyReport) {
				...
				exporter.setParameter(JRExporterParameter.IGNORE_PAGE_MARGINS, new Boolean(true));
