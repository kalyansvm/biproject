...
<xsl:template match="column-heading[@indent]">
  ...
  <fo:block text-align="left" font-size="10pt" font-family="simhei, serif" line-height="14pt" space-before="0.5mm" space-after="0.5mm">
    <xsl:if test="@indent">
...
<xsl:template match="cell">
    <fo:table-cell border="solid black 0.5pt" padding="2pt" border-collapse="collapse"> <!--border-style="solid" border-width="0.2mm"> -->
        <xsl:call-template name="odd-even">
         ...
         <fo:block text-align="right" padding="2pt" font-size="10pt" font-family="simhei, serif" line-height="14pt" space-before="0.2mm" space-after="0.2mm" text-indent="1mm">
