...
public class ChartComponent extends ComponentSupport implements ModelChangeListener {
	...
	private Resources resources = Resources.instance(ChartComponent.class);
	...
	*/
	...
	String fontName = getResources().getString("jsp.wcf.chart.sansserif");
	int fontStyle = java.awt.Font.BOLD;
	int fontSize = 18;
	String slicerFontName = getResources().getString("jsp.wcf.chart.sansserif");
	int slicerFontStyle = java.awt.Font.PLAIN;
	int slicerFontSize = 12;
	String axisFontName = getResources().getString("jsp.wcf.chart.sansserif");
	int axisFontStyle = java.awt.Font.PLAIN;
	int axisFontSize = 12;
	String axisTickFontName = getResources().getString("jsp.wcf.chart.sansserif");
	int axisTickFontStyle = java.awt.Font.PLAIN;
	int axisTickFontSize = 12;
	String legendFontName = getResources().getString("jsp.wcf.chart.sansserif");
	...
	public ChartComponent(String id, Component parent, String ref, String baseDisplayURL, String controllerURL, RequestContext context) {
		...
		this.locale = Resources.instance().instance().instance().getLocaleContextHolderLocale();
		if (this.locale == null) {
	...
	public Document render(RequestContext context) throws Exception {
		...
		if (dirty) {
			...
			DefaultCategoryDataset dataset = null;
			  ...
			  case 1 :
				logger.info(
						getResources().getString("jpivot.ChartComponent.message.oneDD"));
				dataset = build1dimDataset();
				break;
			  case 2 :
				logger.info(
						getResources().getString("jpivot.ChartComponent.message.twoDD"));
				dataset = build2dimDataset();
				break;
			  default :
				logger.error(
						getResources().getString("jpivot.ChartComponent.message.wrongDimensions"));
				throw new IllegalArgumentException(
						getResources().getString("jpivot.ChartComponent.error.wrongDimensions"));
			}
			// re-set dirty flag
			dirty = false;
			...
			switch (chartType) {
				...
				default :
					throw new Exception(
							getResources().getString("jpivot.ChartComponent.error.unknownChartType"));
			}
			try {
				...
				if ( plot instanceof CategoryPlot ) {
					...
					catPlot.getDomainAxis().setCategoryLabelPositions(newp);
                                    ...
                                    piePlot.setNoDataMessage(
                                    		getResources().getString("jpivot.ChartComponent.error.noData"));
                                }
				...
				filename = 
					getResources().getString("jpivot.ChartComponent.label.filename");
				dirty = true;
			}
		}
		// new DOM document
...
*/
		...
		logger.debug(
				resources.getString("jpivot.ChartComponent.message.encoding", new Object[]{getResources().getCharacterEncoding()}));
		InputStream stream =
			new ByteArrayInputStream(xchart.getBytes(getResources().getCharacterEncoding()));
	...
	private String buildSlicer() {
		...
		slicer.append(getResources().getString("jpivot.ChartComponent.label.slicer") + " ");
	...
	private DefaultCategoryDataset build1dimDataset() {
		...
		String series = 
			getResources().getString("jpivot.ChartComponent.label.series");
