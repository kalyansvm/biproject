...
public class CalendarControlTag extends TagSupport {
  ...
  public int doStartTag() throws JspException {
    ...
    try {
      ...
      out.write("  jscalendarMonthName = new Array(" + res.getString("wcf.CalendarControlTag.cal.month.fullnames") + ");\n");      
      //jscalendarMonthName2 = new Array("JAN","FEB","MAR","APR","MAY","JUN","JUL","AUG","SEP","OCT","NOV","DEC");
      out.write("  jscalendarMonthName2 = new Array(" + res.getString("wcf.CalendarControlTag.cal.month.shortnames") + ");\n");      
      //var jscalendarDayName = jscalendarStartAt==0 ? new Array("Sun","Mon","Tue","Wed","Thu","Fri","Sat") : new Array("Mon","Tue","Wed","Thu","Fri","Sat","Sun");
      out.write("  jscalendarDayName = " + res.getString("wcf.CalendarControlTag.cal.days.shortnames") + "\n");
      //jscalendarTodayString = "Today is"
      out.write("  jscalendarTodayString = " + res.getString("wcf.CalendarControlTag.cal.todaystring") + ";\n");
      //jscalendarWeekString = "Wk"
      out.write("  jscalendarWeekString = " + res.getString("wcf.CalendarControlTag.cal.weekstring") + ";\n");            
      //var jscalendarGotoString = "Go To Current Month"
      out.write("  jscalendarGotoString = " + res.getString("wcf.CalendarControlTag.cal.goto.current") + "\n");      
      //var jscalendarScrollLeftMessage = "Click to scroll to previous month. Hold mouse button to scroll automatically."
      out.write("  jscalendarScrollLeftMessage = " + res.getString("wcf.CalendarControlTag.cal.scroll.left") + "\n");
      //var jscalendarScrollRightMessage = "Click to scroll to next month. Hold mouse button to scroll automatically."
      out.write("  jscalendarScrollRightMessage = " + res.getString("wcf.CalendarControlTag.cal.scroll.right") + "\n");
      //var jscalendarSelectMonthMessage = "Click to select a month."
      out.write("  jscalendarSelectMonthMessage = " + res.getString("wcf.CalendarControlTag.cal.sel.month") + "\n");
      //var jscalendarSelectYearMessage = "Click to select a year."
      out.write("  jscalendarSelectYearMessage = " + res.getString("wcf.CalendarControlTag.cal.sel.year") + "\n");
      //var jscalendarSelectDateMessage = "Select [date] as date." // do not replace [date], it will be replaced by date.
      out.write("  jscalendarSelectDateMessage = " + res.getString("wcf.CalendarControlTag.cal.sel.date") + "\n");
      //Again initialize after change of the variables 
