...
public class ChangeOrderMgr implements RenderListener {
  ...
  public void startRendering(RequestContext context) {
    ...
    titleFwd = res.getString("jsp.wcf.ChangeOrderMgr.titleFwd");
    titleBwd = res.getString("jsp.wcf.ChangeOrderMgr.titleBwd");
    titleCut = res.getString("jsp.wcf.ChangeOrderMgr.titleCut");
    titleUncut = res.getString("jsp.wcf.ChangeOrderMgr.titleUncut");
    titlePasteBefore = res.getString("jsp.wcf.ChangeOrderMgr.titlePasteBefore");
    titlePasteAfter = res.getString("jsp.wcf.ChangeOrderMgr.titlePasteAfter");
