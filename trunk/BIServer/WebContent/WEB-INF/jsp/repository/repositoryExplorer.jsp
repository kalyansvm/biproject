...
<table width="100%"  cellpadding=0 cellspacing=0 id="repo_outside_table">
	<tr>
		...
		<td style="border-top:solid 1px #FFCC99;border-bottom:solid 1px #FFCC99;padding-bottom:5px;">
			<table height="100%" width="230" style="border:solid 1px #FFCC99;border-left:none;border-top:none;">
				<tr><td valign="top">
				 <div id="left_panel" style='overflow:auto'></div>
				</td></tr>
			</table>
		</td>
		<td width="5" style="border-right:solid 1px #FFCC99;border-bottom:solid 1px #FFCC99;" >&nbsp;</td>
