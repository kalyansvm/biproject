...
// $Id: calendar.js,v 1.3 2005/11/28 10:15:56 ionut Exp $
...
// start TZ patch
Date.parseDate = function(str, fmt, tzOffset) {
	var today = new Date();

	if (typeof tzOffset == "number")
		today = new Date(today.getTime() + today.getTimezoneOffset()*60000 + tzOffset);
// end TZ patch
